...
OEBRIDGE_EXTRA_POST_HOSTENV_FILE_PATH := "${THISDIR}/files/${@bb.utils.contains('DISTRO_FEATURES', 'ibrobot', 'oebridge-extra-command-ibrobot_post_hostenv.sh', 'oebridge-extra-command_post_hostenv.sh', d)}"
