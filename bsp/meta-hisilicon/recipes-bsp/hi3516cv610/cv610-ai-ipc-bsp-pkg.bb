DESCRIPTION = "BSP package for cv610-ai-ipc board (WS73 USB WiFi)"
SECTION = "base"
LICENSE = "MIT"
...
do_install () {
    ...
    install -m 0755 ${WORKDIR}/start_wifi.sh ${D}/root/start_wifi.sh
    install -m 0644 ${WORKDIR}/wpa_supplicant.conf ${D}${sysconfdir}/Wireless/wpa_supplicant.conf
    ...
    echo "cv610-ai-ipc" > ${D}${sysconfdir}/hostname
}

RDEPENDS:${PN} += "ws73-usb-driver"
