...
python do_fetch() {
    # download rkbin repo for patches
    d.setVar("OPENEULER_REPO_NAME", "rkbin")
    d.setVar("OPENEULER_LOCAL_NAME", 'rkbin')
...
DEPENDS_append = " coreutils-native ${PYTHON_PN}-pyelftools-native"
