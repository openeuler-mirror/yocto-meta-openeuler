def init_environment(){
    ...
    if (env.openEulerImgRemoteDir == null || env.openEulerImgRemoteDir == ""){
        env.openEulerImgRemoteDir = "/data/logs/packages/openEuler-24.03-LTS"
    }
    ...
    if (env.baseImgUrl == null  || env.baseImgUrl == ""){
        env.baseImgUrl = "https://build-logs.openeuler.openatom.cn:38080/packages/openEuler-24.03-LTS"
    }
    if (env.targetImgUrl == null || env.targetImgUrl == ""){
        env.targetImgUrl = "http://121.36.84.172/dailybuild/EBS-openEuler-24.03-LTS/embedded_img"
    }
