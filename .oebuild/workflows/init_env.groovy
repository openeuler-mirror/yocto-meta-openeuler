def init_environment(){
    ...
    if (env.yoctoBranch == null || env.yoctoBranch == ""){
        env.yoctoBranch = "openEuler-24.03-LTS"
    }
    // set test mugen
    ...
    if (env.openEulerImgRemoteDir == null || env.openEulerImgRemoteDir == ""){
        env.openEulerImgRemoteDir = "/var/www/html/openeuler-ci/openEuler-24.03-LTS"
    }
    // set comment
    ...
    if (env.ciBranch == null || env.ciBranch == ""){
        env.ciBranch = "openEuler-24.03-LTS"
    }
    ...
    if (env.baseImgUrl == null  || env.baseImgUrl == ""){
        env.baseImgUrl = "http://43.136.114.130/openeuler-ci/openEuler-24.03-LTS"
    }
    if (env.targetImgUrl == null || env.targetImgUrl == ""){
        env.targetImgUrl = "http://121.36.84.172/dailybuild/EBS-openEuler-24.03-LTS/EBS-openEuler-24.03-LTS/embedded_img"
    }
