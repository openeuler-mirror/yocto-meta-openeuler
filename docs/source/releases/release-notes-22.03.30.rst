...
* 构建系统
   - 初步的openEuler Embedded构建体系，详见 `容器环境下的快速构建指导 <https://pages.openeuler.openatom.cn/embedded/docs/build/html/openEuler-22.03/yocto/quickbuild/container-build.html>`_
* 其他
