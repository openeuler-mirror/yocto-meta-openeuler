...
.. csv-table::
   ...
   "rpcbind",	"rpcbind-1.2.6-r0.aarch64.rpm",	"rpcbind",	"与传输无关的RPC端口映射程序",	"Rpcbind是端口映射的替代品。虽然portmap仅支持INET (IPv4)上的UDP和TCP传输，但rpcbind可以配置为在TI-RPC支持的各种传输上工作。这包括IPv6上的TCP和UDP。此外，rpcbind还提供了有关端口映射的额外功能。",	"glibc >= 2.34;libtirpc3 >= 1.3.2"
