...
.. image:: ./hipico-burn.image/image_20241030100921.jpg

网络连接示意如下。

.. image:: ./hipico-burn.image/wx_17302726487813.png
...
1. 打开烧录工具，第一次打开时会提示选择芯片，选择\ **Hi3516CV610**。
    ...
    .. image:: ./hipico-burn.image/image-20241027222134378.png

2. 点击BurnTool进入烧录界面。

    .. image:: ./hipico-burn.image/image-20241027222240284.png

3. 选择烧录方式及镜像包。

   网络烧录选择传输方式为网口，刷新本地PC配置，选择按分区烧写，打开分区表文件。

    .. image:: ./hipico-burn.image/image-20241030112908718.png
 
    .. image:: ./hipico-burn.image/image-20241030114043195.png
   ...
   a.  根据设备管理器->端口，查看连接板端的串口，选择工具中的串口。
        ...
        .. image:: ./hipico-burn.image/image-20241030113424150.png

   b.  运行CMD命令提示符窗口，运行ipconfig，查看本机IP信息，选择工具中的服务器IP。

        .. image:: ./hipico-burn.image/image-20241030113656811.png

4. 选择rootfs镜像。

   镜像包中分区表文件未写明rootfs镜像名称，自行选择对应的镜像文件。

    .. image:: ./hipico-burn.image/image-20241030115141283.png

5. 开始烧录。

   点击烧写后，下方控制台打印蓝色字体“串口已经连接，请给单板上电，若已经上电，请断电后重新上电。”点按RST按键，重新上电。出现“#####”打印，即开始烧录。

    .. image:: ./hipico-burn.image/image-20241030115512916.png

6. 下方的控制台会显示烧录的详细过程，烧录错误时可根据控制台中的信息判断错误原因。

    .. image:: ./hipico-burn.image/image-20241030131805870.png

7. 烧录成功。

    .. image:: ./hipico-burn.image/image-20241030131859441.png
...
1. 运行\ **zadig_2.5.exe**\ 文件。
    ...
    .. image:: ./hipico-burn.image/image-20241027214656594.png

2. 选择 Options->List All Devices，将 List All Devices 勾上。

    .. image:: ./hipico-burn.image/image-20241027214854749.png
...
4. 在红色方框位置选择正确的设备（USBBurn），然后方框内选择驱动（libusbK）。点击“Install Driver”（未安装过）或者“Replace Driver”（已安装过）。
    ...
    .. image:: ./hipico-burn.image/image-20241027220855071.png

    .. image:: ./hipico-burn.image/image-20241027221410263.png

    .. image:: ./hipico-burn.image/image-20241027221445335.png

5. 重新进入update模式按照上述的方式继续安装\ **libusb-win32**。

    .. image:: ./hipico-burn.image/image-20241027221257451.png
...
3. 选择烧录方式及镜像包。
    ...
    .. image:: ./hipico-burn.image/image-20241027222610538.png

4. 选择rootfs镜像。

    .. image:: ./hipico-burn.image/image-20241027223022906.png

    .. image:: ./hipico-burn.image/image-20241027223052428.png

5. 开始烧录。

    .. image:: ./hipico-burn.image/image-20241027223453489.png

6. 下方的控制台会显示烧录的详细过程，烧录错误时可根据控制台中的信息判断错误原因。

    .. image:: ./hipico-burn.image/image-20241027223542816.png

7. 烧录成功。

    .. image:: ./hipico-burn.image/image-20241027223742358.png
...
.. image:: ./hipico-burn.image/image-20241030130649741.png
...
.. image:: ./hipico-burn.image/image-20241030130217123.png
...
.. image:: ./hipico-burn.image/image-20241030130927176.png
...
.. image:: ./hipico-burn.image/image-20241030132345561.png

右键单击以太网->属性，或点击以太网->属性；选择Internet。
协议版本4（TCP/IPv4）->属性；

.. image:: ./hipico-burn.image/image-20241030132625638.png

选择使用下面的IP地址，输入修改的IP地址，子网掩码，默认网关；确定->关闭。

.. image:: ./hipico-burn.image/image-20241030132834332.png
...
.. image:: ./hipico-burn.image/image-20241030131525947.png
