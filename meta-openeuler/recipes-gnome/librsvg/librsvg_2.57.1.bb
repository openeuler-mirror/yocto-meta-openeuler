...
# replace by oe: inherit cargo_common gnomebase pixbufcache gobject-introspection rust vala gi-docgen cargo-update-recipe-crates

# replace by oe: require ${BPN}-crates.inc
...
# replace by oe:  BASEDEPENDS:append = " cargo-native"

# replace by oe:  export RUST_BACKTRACE = "full"
# replace by oe:  export RUSTFLAGS

# replace by oe:  export RUST_TARGET = "${RUST_HOST_SYS}"

RUSTFLAGS:append:mips = " --cfg crossbeam_no_atomic_64"
RUSTFLAGS:append:mipsel = " --cfg crossbeam_no_atomic_64"
RUSTFLAGS:append:powerpc = " --cfg crossbeam_no_atomic_64"

# replace by oe:  do_configure[postfuncs] += "cargo_common_do_configure"

# replace by oe:  inherit rust-target-config
...
# replace by oe:  do_compile:prepend() {
# replace by oe:      sed -ie 's,"linker": ".*","linker": "${RUST_TARGET_CC}",g' ${RUST_TARGETS_DIR}/${RUST_HOST_SYS}.json
# replace by oe:  }
