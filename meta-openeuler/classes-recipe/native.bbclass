...
require ${COREBASE}/meta/classes-recipe/native.bbclass
...
EXTRA_NATIVE_PKGCONFIG_PATH:append = "${@['', '${OPENEULER_PREBUILD_PKGCONFIG_PATH}']['${OPENEULER_PREBUILT_TOOLS_ENABLE}' == 'yes']}"
