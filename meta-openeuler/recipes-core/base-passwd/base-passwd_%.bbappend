...
# it's casued by shadow-native where the patch "0002-Allow-for-setting-password-in-clear-text"
# cannot be applie， because openeuler's shadow version is 4.9, and the patch is suitable for
