...
SRC_URI = "file://libnl3/${BP}.tar.gz \
           file://libnl3/backport-lib-add-include-netlink-private-nl-auto-h-header.patch \
           file://libnl3/backport-lib-use-proper-int-type-for-id-attributes-in-nl_object_identical.patch \
           file://libnl3/backport-route-link-add-RTNL_LINK_REASM_OVERLAPS-stat.patch \
           file://libnl3/backport-route-link-Check-for-null-pointer-in-macvlan.patch \
           file://libnl3/backport-rtnl-link-fix-leaking-rtnl_link_af_ops-in-link_msg_parser.patch \
           file://libnl3/backport-rtnl-route-fix-NLE_NOMEM-handling-in-parse_multipath.patch \
           file://libnl3/solve-redefinition-of-struct-ipv6_mreq.patch \
           file://run-ptest \
          "
