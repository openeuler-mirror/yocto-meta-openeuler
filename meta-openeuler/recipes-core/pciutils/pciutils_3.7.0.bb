...
SRC_URI = "file://pciutils/${BP}.tar.gz \
           file://pciutils/0000-pciutils-2.2.1-idpath.patch \
           file://pciutils/0001-pciutils-dir-d.patch \
...
FILES_${PN}-ids = "${datadir}/hwdata/pci.ids*"
