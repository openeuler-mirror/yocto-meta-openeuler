...
# Optional modules (e.g., _tkinter, readline) not being found is acceptable
# in native builds without full X11/GUI/readline dev headers.
...
# Hard build failures are still fatal
