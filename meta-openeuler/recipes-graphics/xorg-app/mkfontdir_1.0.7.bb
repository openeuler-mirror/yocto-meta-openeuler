# ref: https://git.openembedded.org/openembedded-core/tree/meta/recipes-graphics/xorg-app/mkfontdir_1.0.7.bb?h=thud
...
RDEPENDS:${PN} += "mkfontscale"
RDEPENDS:${PN}:class-native += "mkfontscale-native"
