# openeuler's native.bbclass is almost the same as poky's native.bbclass except EXTRA_NATIVE_PKGCONFIG_PATH
# default value is reset. In the future, if the problem of NATIVE and NATIVESDK is fixed,
...
EXTRA_NATIVE_PKGCONFIG_PATH ?= ":${OPENEULER_NATIVESDK_SYSROOT}/usr/lib/pkgconfig:${OPENEULER_NATIVESDK_SYSROOT}/usr/share/pkgconfig"
