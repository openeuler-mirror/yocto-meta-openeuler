...
# NOTE: From meta-virtualization, add some configurations for openeuler
# 1. Set KERNEL_IMAGETYPE, xen doesn't support zImage;
# 2. Add qemu-aarch64 support
# 3. Increase dom0_mem/QB_MEM for openeuler
...
QB_DEFAULT_KERNEL:qemu-aarch64 = "xen-${MACHINE}"
...
QB_MACHINE:qemu-aarch64 = "-machine virt,gic-version=3 -machine virtualization=true"
...
QB_DTB:qemu-aarch64 = "${IMAGE_NAME}.qemuboot.dtb"
QB_DTB_LINK:qemu-aarch64 = "${IMAGE_LINK_NAME}.qemuboot.dtb"
